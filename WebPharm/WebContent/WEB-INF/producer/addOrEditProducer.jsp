		...
		<div class="main">
			...
			<form action="AllProducers" method="POST">
				<button class="addButton3">
					<img src="img/add.png" alt="addProducer" width="100" height="100"
						style="vertical-align: middle"
						title=${id>0 ? "edit producer" : "add producer"}>
				</button>
				<input type="hidden" name="id" value="${id}" /> <input
					type="hidden" name="selectedCountry" value="${selectedCountry}" />
				<table class="table1" border="0">
					...
					<tr>
						...
						<td class="td1"><input type="text" name="producerTitle"
							placeholder="length<=20 symbols" value="${producerTitle}"
							tabindex="1" /></td>
					...
					<tr>
						...
						<td class="td1"><select size="1" name="country">
								<c:forEach items="<%=Country.values()%>" var="country">
									<option ${country == selectedCountry ? 'selected' : ''}
			...
			<br> <a href="#" onclick="history.back()" class="returnButton"><img
